...
describe("engine foundation", () => {
  it.skipIf(!hasGoToolchain)(
    ...
    async () => {
      ...
      const { metricsPath, planPath, reportPath } = requireGoArtifactPaths(result.artifacts);
...
function requireGoArtifactPaths(artifacts: Awaited<ReturnType<typeof runEngine>>["artifacts"]): {
  metricsPath: string;
  planPath: string;
  reportPath: string;
} {
